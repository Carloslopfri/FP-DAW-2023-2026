...
public class CuentaCorrientePersonal extends CuentaCorriente implements Imprimible {
    ...
    public CuentaCorrientePersonal(Persona titular, double saldo, int CCC, double comisionMantenimiento) {

        super(titular.getNombre() + " " + titular.getApellidos(), saldo, CCC, comisionMantenimiento);
